...
function disableTab() {
    ...
    if (popup) {
        (_a = popup.parentNode) === null || _a === void 0 ? void 0 : _a.removeChild(popup);
    }
    clearHighlight();
}
    ...
    switch (keyDown.keyCode) {
                ...
                for (let i = 0; i < 10; i++) {
                    ...
                    if (ret === 0) {
                        ...
                        if (savedRangeNode && savedRangeNode.parentNode) {
                            ...
                            savedRangeOffset = 0;
                            offset = savedRangeNode ? ((_a = savedRangeNode.textContent) === null || _a === void 0 ? void 0 : _a.length) || 0 : 0;
                        }
                    }
                }
            }
        ...
        case 71: // 'g'
            if (config.grammar !== 'no' && savedSearchResults.grammar) {
                let sel = encodeURIComponent(((_b = window.getSelection()) === null || _b === void 0 ? void 0 : _b.toString()) || '');
        ...
        case 84: // 't'
            {
                let sel = encodeURIComponent(((_c = window.getSelection()) === null || _c === void 0 ? void 0 : _c.toString()) || '');
        ...
        case 86: // 'v'
            if (config.vocab !== 'no' && savedSearchResults.vocab) {
                let sel = encodeURIComponent(((_d = window.getSelection()) === null || _d === void 0 ? void 0 : _d.toString()) || '');
        ...
        case 50: // '2'
            if (keyDown.altKey) {
                let sel = encodeURIComponent(((_e = window.getSelection()) === null || _e === void 0 ? void 0 : _e.toString()) || '');
        ...
        case 51: // '3'
            if (keyDown.altKey) {
                let sel = encodeURIComponent(((_f = window.getSelection()) === null || _f === void 0 ? void 0 : _f.toString()) || '');
        ...
        case 52: // '4'
            if (keyDown.altKey) {
                let sel = encodeURIComponent(((_g = window.getSelection()) === null || _g === void 0 ? void 0 : _g.toString()) || '');
        ...
        case 53: // '5'
            if (keyDown.altKey) {
                let sel = encodeURIComponent(((_h = window.getSelection()) === null || _h === void 0 ? void 0 : _h.toString()) || '');
        ...
        case 54: // '6'
            if (keyDown.altKey) {
                let sel = encodeURIComponent(((_j = window.getSelection()) === null || _j === void 0 ? void 0 : _j.toString()) || '');
...
function onMouseMove(mouseMove) {
    var _a;
    if (mouseMove.target instanceof HTMLElement &&
    ...
    if (rangeNode &&
        ...
        rangeOffset === ((_a = rangeNode.textContent) === null || _a === void 0 ? void 0 : _a.length)) {
...
function processSearchResult(result) {
    ...
    if (!result || !((_a = result.data) === null || _a === void 0 ? void 0 : _a.length)) {
        hidePopup();
        clearHighlight();
        return;
    }
...
function shouldAddSpaceBetweenNodes(prevNode, nextNode) {
    var _a, _b;
    ...
    const prevElementName = (_a = prevParent.nodeName) === null || _a === void 0 ? void 0 : _a.toLowerCase();
    const nextElementName = (_b = nextParent.nodeName) === null || _b === void 0 ? void 0 : _b.toLowerCase();
...
function showPopup(html, elem = null, x = 0, y = 0, looseWidth = false) {
    if (!x || !y) {
        x = y = 0;
    }
...
function highlightMatch(doc, rangeStartNode, rangeStartOffset, matchLen, selEndList) {
    ...
    sel === null || sel === void 0 ? void 0 : sel.empty();
    sel === null || sel === void 0 ? void 0 : sel.addRange(range);
    selText = (sel === null || sel === void 0 ? void 0 : sel.toString()) || null;
}
...
function makeHtml(result, showToneColors = true) {
    let html = '';
    const texts = [];
    let hanziClass;
    if (result === null) {
