...
function enableTabAndSendMessage(tabId) {
...
chrome.runtime.onMessage.addListener((request, sender, callback) => {
    ...
    switch (request.type) {
        case 'search':
            {
                ensureDictLoaded().then((tiengvietDict) => {
                    const response = tiengvietDict.search(request === null || request === void 0 ? void 0 : request.text);
...
function ensureDictLoaded() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield fetch(chrome.runtime.getURL('data/vnedict.txt'));
